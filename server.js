...
if (!MONGODB_URI) {
  ...
  console.error('   Example: mongodb+srv://username:password@cluster.mongodb.net/minihaai?retryWrites=true&w=majority');
  process.exit(1);
}
...
connectMongoDB().then(() => {
  ...
  console.error('❌ Failed to connect to MongoDB after retries. Server not started.');
  process.exit(1);
});
